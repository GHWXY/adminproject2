...
<%--顶部--%>
<div data-options="region:'north'" style="height:80px; background: #ec4e00; padding: 20px 20px">
    <img src="${pageContext.request.contextPath}/static/images/main_logo.png">
...
<%--底部--%>
<div data-options="region:'south'" style="height:30px; border-bottom: 3px solid #ec4e00">
    <p align="center" style="font-size: 10px">撩课学院</p>
</div>
<%--左侧菜单--%>
